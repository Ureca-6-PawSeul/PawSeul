...
const Detail = () => {
  ...
  return (
    <Wrapper direction="column" justify='flex-start' padding="0 0 80px 0" backgroundColor={colors.Gray50} height='fit-content'>
      <Image src={mock.product_img} alt="product_img" />
      <Flex direction="column" gap={12} padding="60px 0 32px 0" backgroundColor={colors.White}>
        <Flex
          direction="column"
          align="flex-start"
          gap={7}
      ...
      <Flex direction="column" gap={16} justify="flex-start" padding="32px 16px 48px 16px" margin="16px 0 0" backgroundColor={colors.White}>
        <DetailText typo="Heading3" justify="flex-start">
          상품 설명
        </DetailText>
        <DetailTable tableData={descriptionData} />
      </Flex>
      <Flex direction="column" padding="0 0 32px" backgroundColor={colors.White}>
